...
latex_documents = [
    (master_doc, 'pymedext_core.tex', 'pymedext\\_core Documentation',
...
man_pages = [
    (master_doc, 'pymedext_core', 'pymedext_core Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pymedext_core', 'pymedext_core Documentation',
     author, 'pymedext_core', 'One line description of project.',
     'Miscellaneous'),
]
